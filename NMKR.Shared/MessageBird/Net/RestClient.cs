...
namespace MessageBird.Net
{
    ...
    public class RestClient : IRestClient
    {
        ...
        public IProxyConfigurationInjector ProxyConfigurationInjector { get; }
            ...
            switch (statusCode)
            {
                ...
                case HttpStatusCode.UnprocessableEntity:
                    using (var responseReader = new StreamReader(httpWebResponse.GetResponseStream()))
                    {
                        ...
                        return new(String.Format("Unknown error for {0}", statusCode), e);
                    }
                ...
                case HttpStatusCode.NetworkConnectTimeoutError:
                    return new("Something went wrong on our end, please try again", e);
                default:
                    return new(String.Format("Unhandled status code {0}", statusCode), e);
            }
        }
    }
}
