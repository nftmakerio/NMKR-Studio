...
namespace MessageBird
{
    public class Client
    {
        ...
        public static Client CreateDefault(string accessKey, IProxyConfigurationInjector proxyConfigurationInjector = null)
        {
            ...
            return new(new RestClient(accessKey, proxyConfigurationInjector));
        }
        ...
        public Message ViewMessage(string id)
        {
            ...
            var messageToView = new Messages(new(id));
        ...
        public VoiceMessage ViewVoiceMessage(string id)
        {
            ...
            var voiceMessageToView = new VoiceMessages(new(id));
        ...
        public Objects.Hlr RequestHlr(long msisdn, string reference)
        {
            ...
            var hlrToRequest = new Resources.Hlr(new(msisdn, reference));
        ...
        public Objects.Hlr ViewHlr(string id)
        {
            ...
            var hlrToView = new Resources.Hlr(new(id));
        ...
        {
            var lookup = new Resources.Lookup(new(phonenumber, optionalArguments));
        ...
        public Objects.LookupHlr RequestLookupHlr(long phonenumber, string reference, LookupHlrOptionalArguments optionalArguments = null)
        {
            ...
            var lookupHlr = new Resources.LookupHlr(new(phonenumber, reference, optionalArguments));
        ...
        {
            var lookupHlr = new Resources.LookupHlr(new(phonenumber, optionalArguments));
