...
{
    public class PreparedPaymentTransactionsPaymentGatewayRandomClass : PreparedPaymentTransactionsPaymentGatewayClass
    {
        public PreparedPaymentTransactionsPaymentGatewayRandomClass(EasynftprojectsContext db, IConnectionMultiplexer redis, PaymentTransactionTypes PaymentTransactionType) : base(db,redis, PaymentTransactionType)
        {
        }
        ...
        public override ApiErrorResultClass CheckParameter(CreatePaymentTransactionClass paymenttransaction, Nftproject project, ApiErrorResultClass result, out int statuscode)
        {
            ...
            statuscode = 0;
            if (paymenttransaction.PaymentTransactionType != PaymentTransactionTypes.paymentgateway_nft_random)
                return result;
