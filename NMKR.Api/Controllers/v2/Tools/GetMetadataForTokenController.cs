...
namespace NMKR.Api.Controllers.v2.Tools
{
    ...
    [ApiController]
    [ApiVersion("2")]
    public class GetMetadataForTokenController : ControllerBase
    {
        private readonly IConnectionMultiplexer _redis;

        public GetMetadataForTokenController(IConnectionMultiplexer redis)
        {
            _redis = redis;
        }
        ...
        /// <response code="200">Returns the Metadata as String</response>
            ...
            string tokennamehex)
        {
          //  string apikey = Request.Headers["authorization"];
            ...
            var metadata=await KoiosFunctions.GetMetadataAsync(policyid, tokennamehex);
            CheckCachedAccess.SetCachedResult(_redis, apifunction, apikey, 200, metadata, apiparameter);
            return Ok(metadata);
        }
    }
}
