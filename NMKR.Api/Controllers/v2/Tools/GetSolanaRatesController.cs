...
namespace NMKR.Api.Controllers.v2.Tools
{
    ...
    public class GetSolanaRatesController : ControllerBase
    {
        private readonly IConnectionMultiplexer _redis;

        public GetSolanaRatesController(IConnectionMultiplexer redis)
        {
            _redis = redis;
        }
        ...
        public async Task<IActionResult> Get([OpenApiHeaderIgnore][FromHeader(Name = "authorization")] string apikey)
        {
            ...
            var rates = (await GlobalFunctions.GetNewRatesAsync(_redis, Coin.SOL));
