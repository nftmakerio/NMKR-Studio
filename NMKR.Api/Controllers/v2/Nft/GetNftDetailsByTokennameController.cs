...
namespace NMKR.Api.Controllers.v2.Nft
{
    ...
    [ApiController]
    [ApiVersion("2")]
    public class GetNftDetailsByTokennameController : ControllerBase
    {
        private readonly IConnectionMultiplexer _redis;

        public GetNftDetailsByTokennameController(IConnectionMultiplexer redis)
        {
            _redis = redis;
        }
        ...
        [HttpGet("{projectuid}/{nftname}")]
        [MapToApiVersion("2")]
        [SwaggerOperation(
            Tags = new[] { "NFT" }
        )]
        public async Task<IActionResult> Get([OpenApiHeaderIgnore][FromHeader(Name = "authorization")] string apikey, string projectuid, string nftname)
        {
           // string apikey = Request.Headers["authorization"];
            ...
            string apiparameter = projectuid + nftname;
            ...
            var nftx = await (from a in db.Nfts
                    ...
                    .AsSplitQuery()
                where a.Nftproject.Uid == projectuid &&
