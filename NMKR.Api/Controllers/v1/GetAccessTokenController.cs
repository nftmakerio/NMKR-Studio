...
namespace NMKR.Api.Controllers
{
    ...
    public class GetAccessTokenController : ControllerBase
    {
        ...
        /// <response code="200">Returns the GetAccessTokenResultClass with a valid access token</response>
        ...
        [HttpGet("{secret}/{onetimepassword}")]
        [MapToApiVersion("1")]
        public IActionResult Get(string secret, string onetimepassword)
        {
            ...
            var access = (from a in db.Getaccesstokensusers
